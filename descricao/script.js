...
async function adcdesc() {
  ...
  desc.insertAdjacentHTML(
    ...
    `
        <div class="axl">
     <div id=${pokemon.name} class="containerpoke" style="background-color:${
      cores[pokemon.types[0].type.name]
    }">
     </div> 
         <p class="namepoke">${pokemon.name} #${pokemon.id}</p>
       <img class="imgpok" src="${
         pokemon.sprites.other.dream_world.front_default
       }">
       <div class="bloco">  <p class="ola3"  style="background-color:${
         cores[pokemon.types[0].type.name]
       }">  ${pokemon.types[0].type.name}</p></div>
        ...
        <div class="div-p">
        <p class="stats">
        <strong><em>vida:</em></strong> ${pokemon.stats[0].base_stat}
           </p>
           ...
           <div class="barra1">
                <div class="progreco"
                   ...
                   <p class="stats">
        <strong><em>ataque:</em></strong> ${pokemon.stats[1].base_stat}
            <div class="barra1">
                <div class="progreco"
                   ...
                   <p class="stats">
        <strong><em>defesa:</em></strong> ${pokemon.stats[2].base_stat}
            <div class="barra1">
                <div class="progreco"
                   ...
                   <p class="stats">
        <strong><em>velocidade:</em></strong> ${pokemon.stats[5].base_stat}
            <div class="barra1">
                <div class="progreco"
